...
( sleep 80
  echo "say M43 mutations batch 1 (blocks + light emitters)"
  ...
  -Dminecraftrust.m1.native_state=ON_EXPERIMENTAL \
...
( M1_MODLIST="$ROOT/machine/targetA/mod-ids.json" M1_USER=m2cebot \
    M1_TP=30 M1_TP_INTERVAL=3 M1_TP_STEP=150 M1_TP_Z_STEP=90 M1_TP_SPAN=400 \
    HOLD_SECONDS=380 SESSIONS=1 \
    python "$ROOT/tools/targeta_client.py" m43 127.0.0.1 25565 >/dev/null 2>&1 || true ) &
