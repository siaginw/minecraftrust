...
( sleep 80
  echo "say M42E mutations batch 1 (blocks + light emitters)"
...
( M1_MODLIST="$ROOT/machine/targetA/mod-ids.json" M1_USER=m2cebot \
    ...
    python "$ROOT/tools/targeta_client.py" m42e 127.0.0.1 25565 >/dev/null 2>&1 || true ) &
