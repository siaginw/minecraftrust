...
case "$PACK" in
  C) SRC="$ROOT/machine/targetC/server"; SRVMARK="forge-1.12.2-14.23.5.2846-universal.jar"
     PORT=25567; BOTUSER=perfbotb; LABEL=m55rev-shadow; MODLIST="$ROOT/machine/targetC/mod-ids.json" ;;
...
( sleep 60
  echo "say M55 validation rig: stable resends"
  sleep 280
  echo "stop"
  sleep 60
