...
( sleep 80
  echo "say M42C mutations batch 1 (blocks + light emitters)"
  ...
  sleep 260
  echo "say M42C mutations batch 2"
...
( M1_MODLIST="$ROOT/machine/targetA/mod-ids.json" M1_USER=m2cebot \
    ...
    python "$ROOT/tools/targeta_client.py" m42c 127.0.0.1 25565 >/dev/null 2>&1 || true ) &
